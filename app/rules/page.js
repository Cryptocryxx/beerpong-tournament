    ...
    return (
        <div className="relative min-h-screen w-screen flex flex-col items-center p-4">
            ...
            <div className="w-11/12 max-w-3xl bg-black/60 text-white text-lg p-6 rounded-lg mt-6 shadow-lg">
                ...
                <p><strong>Balls Back:</strong> Falls ein Team beide Würfe in unterschiedliche Becher trifft, erhält es die Bälle zurück und darf erneut werfen.</p>
                
                <p><strong>Bombe:</strong> Falls ein Team es schafft, beide Bälle in denselben Becher zu werfen, werden drei Becher entfernt und das Team erhält Balls Back.</p>

                <p><strong>Trickshot:</strong> Falls der Ball über den Tisch zurückrollt und gefangen wird, bevor er den Boden berührt, darf der Spieler einen Trickshot ausführen.</p>

                <p><strong>Island Call:</strong> Steht ein Becher allein, darf ein Spieler einmal pro Spiel „Island“ ansagen. Trifft der Spieler diesen Becher, werden zwei Becher entfernt.</p>

                <p><strong>Elbow-Regel:</strong> Beim Werfen darf der Ellenbogen nicht über die Tischkante hinausragen.</p>

                <p><strong>On Fire:</strong> Wenn ein Spieler in zwei aufeinanderfolgenden Runden trifft, muss er „Heating Up“ und dann „On Fire“ sagen. Danach hat er ein zusätzliches Wurfrecht.</p>
                ...
                <p>Das Team, das als Erstes alle Becher des Gegners getroffen hat, gewinnt das Spiel.</p>
                
                <p><strong>Gentleman Agreement:</strong> Es gibt immer einen Rückwurf.</p>
                
                <p><strong>Overtime:</strong> Falls beide Teams den letzten Becher in der gleichen Runde treffen, gibt es eine Verlängerung mit einem einzelnen Becher.</p>
